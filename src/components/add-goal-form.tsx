  ...
  return (
    <>
      ...
      <button
        ...
        className="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg font-semibold transition-colors duration-200 shadow-md flex items-center gap-2"
      >
        <svg
          className="w-5 h-5"
          fill="none"
